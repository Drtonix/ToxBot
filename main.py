...
async def novradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://live.novoeradio.by:8000/novoeradio-128k"))
    await ctx.send ("Радио включено.\nИграет: Новое радио")
@bot.command()
async def fmradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://listen.teploe.net:8100/npkfm"))
    await ctx.send ("Радио включено.\nИграет: Фм радио")
@bot.command()
async def radio90s(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://prmstrm.1.fm:8000/90s"))
    await ctx.send ("Радио включено.\nИграет: Радио 80х")
@bot.command()
async def popradio70s(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://prmstrm.1.fm:8000/70s"))
    await ctx.send ("Радио включено.\nИграет: Поп радио 70х")
@bot.command()
async def counthitsradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://prmstrm.1.fm:8000/acountry"))
    await ctx.send ("Радио включено.\nИграет: Хиты кантри")
@bot.command()
async def rockhitsradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://prmstrm.1.fm:8000/x"))
    await ctx.send ("Радио включено.\nИграет: Хиты рока")
@bot.command()
async def rockfmradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("http://jfm1.hostingradio.ru:14536/rock00.mp3"))
    await ctx.send ("Радио включено.\nИграет: Рок фм радио")
@bot.command()
async def royalretradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("	http://185.39.195.90:8000/nostalgia"))
    await ctx.send ("Радио включено.\nИграет: Ретро")
@bot.command()
async def psychedcradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("	http://psyprog.rupsy.ru:8000/psyprog"))
    await ctx.send ("Радио включено.\nИграет: Психоделик")
@bot.command()
async def radiodetyam(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/rusradio_deti-hi"))
    await ctx.send ("Радио включено.\nИграет: Детское радио")
@bot.command()
async def retrofm(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/retrofm_ru-hi"))
    await ctx.send ("Радио включено.\nИграет: Ретро фм")
@bot.command()
async def radiosssr(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/SSSR-hi"))
    await ctx.send ("Радио включено.\nИграет: Ссср радио")
@bot.command()
async def radiorelaxua(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/radiorelax_ua-hi"))
    await ctx.send ("Радио включено.\nИграет: Украинское радио релакс")
@bot.command()
async def korolishyt(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/Korol_i_Shut-hi"))
    await ctx.send ("Радио включено.\nИграет: Радио Король и Шут")
@bot.command()
async def letov(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/Grazhdanskaja_oborona-hi"))
    await ctx.send ("Радио включено.\nИграет: Радио Гражданская оборона")
@bot.command()
async def classicrock(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/rpr1_de_clasro-hi"))
    await ctx.send ("Радио включено.\nИграет: Классический рок")
@bot.command()
async def heavymetal(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/rpr1_de_metal-hi"))  
    await ctx.send ("Радио включено.\nИграет: Хевиметал")
@bot.command()  
async def rammstein(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/Rammstein-hi"))
    await ctx.send ("Радио включено.\nИграет: Раммштайн")
@bot.command()
async def redhotchilradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/red_hot_chili_peppers-hi"))
    await ctx.send ("Радио включено.\nИграет: Red Hot Chili Peppers радио")
@bot.command()
async def pulsradio80s(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/pulsradio_80s-hi"))
    await ctx.send ("Радио включено.\nИграет: Радио 80х")
@bot.command()
async def dorozhnoeradio(ctx):
    voice_channel = bot.get_channel(928937414913851412)
    player = await voice_channel.connect()
    player.play(FFmpegPCMAudio("https://str.pcradio.ru/dorozhnoe_omsk-hi"))
